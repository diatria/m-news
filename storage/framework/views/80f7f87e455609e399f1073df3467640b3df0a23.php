<?php $__env->startSection('foto-content'); ?>
<div class="col-md-12">
	<div class="card">
		...
		<div class="card-body">
			<div class="basic-form">
				<form action="<?php echo e(url('db_foto/add')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('dashboard.foto.foto_layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>