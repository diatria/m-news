<?php $__env->startSection('mamujutv-content'); ?>
<div class="col-md-12">
	<div class="card">
		...
		<div class="card-body">
			<div class="basic-form">
				<form action="<?php echo e(url('db_mamujutv/change')); ?>/<?php echo e($change->id); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('dashboard.mamujutv.mamujutv_layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>