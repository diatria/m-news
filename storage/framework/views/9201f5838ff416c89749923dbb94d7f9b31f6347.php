					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="nama" class="form-control input-flat" value="<?php echo e($change->nama_iklan); ?>">
							</div>
							<div class="form-group">
								<label >Banner</label>
							...
							<div class="form-group">
								...
								<div class="custom-file input-flat">
									<input type="date" name="expired" class="form-control input-flat" value="<?php echo e($change->expired); ?>">
								</div>
							</div>
							<div class="form-group">
								<label >Keterangan</label>
								<div class="custom-file input-flat">
									<input type="text" name="keterangan" class="form-control input-flat" value="<?php echo e($change->keterangan); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="custom-file input-flat">
									<select name="position" class="form-control">
										<option value="<?php echo e($change->position); ?>"><?php echo e($change->position); ?></option>
