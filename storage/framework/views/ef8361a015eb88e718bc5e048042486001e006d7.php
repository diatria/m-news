        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="navbar navbar-inverse topnav visible-lg visible-md visible-sm" data-spy="affix" data-offset-top="197">
              ...
              <a href="<?php echo e(url('view/'.$menu->nama_kategori)); ?>" style="text-transform: uppercase;"><?php echo e($menu->nama_kategori); ?></a>
          ...
          <!-- 1. Bagian Seluruh Konten
            ...
            <div class="footer">
              <div class="col-sm-12">
                ...
                <div class="col-sm-7">
                  <div class="img-logo">
                    <img src="<?php echo e(asset('images/mnews/LOGO-2.png')); ?>" alt="">
                  </div>
                </div>
                <div class="col-md-3">
