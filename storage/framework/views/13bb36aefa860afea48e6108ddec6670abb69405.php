<?php $__env->startSection('infografis-content'); ?>
<div class="col-md-12">
	<div class="card">
		...
		<div class="card-body">
			<div class="basic-form">
				<form action="<?php echo e(url('db_infografis/add')); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Konten Infografis</label>
...
<?php echo $__env->make('dashboard.infografis.infografis_layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>