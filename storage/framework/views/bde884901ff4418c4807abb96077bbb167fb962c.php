...
<div class="row page-titles">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<?php echo $__env->yieldContent('mamujutv-content'); ?>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="card">
...
<?php $__env->startSection('footer'); ?>
	...
	<script>
		...
		function swaaction(id) {
	        ...
	        function(isConfirm){
	            if (isConfirm) {
	                window.location = "<?php echo e(url('db_mamujutv/destroy/')); ?>/"+id;
	            }
	            else {
	                window.location = "<?php echo e(url('db_mamujutv/change_viewer/')); ?>/"+id;
	            }
	        });
		}
	</script>
