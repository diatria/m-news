            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li><a class="" href="{{url('berita')}}" aria-expanded="false"><i class="fa fa-tachometer"></i>Berita</a></li>
                        ...
                        <li><a class="" href="{{url('kategori')}}" aria-expanded="false"><i class="fa fa-tachometer"></i>Kategori</a></li>
                        <li><a class="" href="#" aria-expanded="false"><i class="fa fa-tachometer"></i>Pengatruran Iklan</a></li>
