@extends('dashboard.infografis.infografis_layout')
@section('infografis-content')
<div class="col-md-12">
	<div class="card">
		...
		<div class="card-body">
			<div class="basic-form">
				<form action="{{url('db_infografis/change')}}/{{$change->id}}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="row">
						<div class="col-md-6">
