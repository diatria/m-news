					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="nama" class="form-control input-flat" value="{{$change->nama_iklan}}">
							</div>
							<div class="form-group">
								<label >Banner</label>
							...
							<div class="form-group">
								...
								<div class="custom-file input-flat">
									<input type="date" name="expired" class="form-control input-flat" value="{{$change->expired}}">
								</div>
							</div>
							<div class="form-group">
								<label >Keterangan</label>
								<div class="custom-file input-flat">
									<input type="text" name="keterangan" class="form-control input-flat" value="{{$change->keterangan}}">
								</div>
							</div>
							<div class="form-group">
